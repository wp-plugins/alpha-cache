...
= 1.1.003 =
* AC will create different caches for different themes. This is important, for example, when you use different themes for mobile devices and PC. Deactivate and then activate the plugin after if you are updating old version.
